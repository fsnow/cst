...
namespace CST
{
    ...
    public class Book
    {
        ...
        {
            get { return longNavPath ?? string.Empty; }
            set { longNavPath = value ?? string.Empty; }
        }
        private string longNavPath = string.Empty;

        public string ShortNavPath
        {
            get { return shortNavPath ?? string.Empty; }
            set { shortNavPath = value ?? string.Empty; }
        }
        private string shortNavPath = string.Empty;
        ...
        {
            get { return chapterListTypes ?? string.Empty; }
            set { chapterListTypes = value ?? string.Empty; }
        }
        private string chapterListTypes = string.Empty;
    }
}
