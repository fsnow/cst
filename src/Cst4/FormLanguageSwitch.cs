    ...
    public class FormLanguageSwitchSingleton
    {
        ...
        protected virtual void ScanNonControls(System.Windows.Forms.ContainerControl containerControl, System.Resources.ResourceManager resources)
        {
            ...
            for (int i = 0; i < fieldInfo.Length; i++)
            {
                ...
                else if (obj is System.Windows.Forms.ToolStripMenuItem)
                {
                    System.Windows.Forms.ToolStripMenuItem menuItem = (System.Windows.Forms.ToolStripMenuItem)obj;
                    menuItem.Enabled = (bool)(GetSafeValue(resources, fieldName + ".Enabled", menuItem.Enabled));
                    menuItem.ShortcutKeys = (System.Windows.Forms.Keys)(GetSafeValue(resources, fieldName + ".ShortcutKeys", menuItem.ShortcutKeys));
                    menuItem.ShowShortcutKeys = (bool)(GetSafeValue(resources, fieldName + ".ShowShortcutKeys", menuItem.ShowShortcutKeys));
                    menuItem.Text = (string)GetSafeValue(resources, fieldName + ".Text", menuItem.Text);
                    //menuItem.Visible = (bool)(GetSafeValue(resources, fieldName + ".Visible", menuItem.Visible));
                }
				else if (obj is System.Windows.Forms.ToolStripButton)
				{
					System.Windows.Forms.ToolStripButton tsb = (System.Windows.Forms.ToolStripButton)obj;
					tsb.Text = (string)GetSafeValue(resources, fieldName + ".Text", tsb.Text);
				}
                else if (obj is System.Windows.Forms.ToolStripLabel)
                {
                    System.Windows.Forms.ToolStripLabel label = (System.Windows.Forms.ToolStripLabel)obj;
                    label.Text = (string)GetSafeValue(resources, fieldName + ".Text", label.Text);
                }
                else if (obj is System.Windows.Forms.ToolStripDropDownButton)
                {
                    System.Windows.Forms.ToolStripDropDownButton tsddb = (System.Windows.Forms.ToolStripDropDownButton)obj;
                    tsddb.Text = (string)GetSafeValue(resources, fieldName + ".Text", tsddb.Text);
                }
                else if (obj is System.Windows.Forms.ToolStripComboBox)
                {
                    System.Windows.Forms.ToolStripComboBox comboBox = (System.Windows.Forms.ToolStripComboBox)obj;
                ...
                else if (obj is System.Windows.Forms.StatusBarPanel)
                {
                ...
                else if (obj is System.Windows.Forms.ColumnHeader)
                {
                ...
                else if (obj is System.Windows.Forms.ToolBarButton)
                {
        ...
        protected virtual void ReloadListItems(System.Windows.Forms.Control control, System.Resources.ResourceManager resources)
        {
            ...
            //else if (control is System.Windows.Forms.ToolStripComboBox)
                //ReloadToolStripComboBoxItems((System.Windows.Forms.ComboBox)control, resources);
        ...
        private void ReloadToolStripComboBoxItems(System.Windows.Forms.ToolStripComboBox comboBox, System.Resources.ResourceManager resources)
        {
            if (comboBox.Items.Count > 0)
            {
                int selectedIndex = comboBox.SelectedIndex;
        ...
        private void ReloadItems(string controlName, IList list, int itemsNumber, System.Resources.ResourceManager resources)
        {
            ...
            if (obj != null)
            {
				...
				// Special case for comboBookSet which has a mix of localizable strings (None, Create New...) and
				// unlocalizable book collection names. This code does not belong here, but it is easier than
				// creating a generalized solution to handle this single case.
				if (controlName.Equals("comboBookSet"))
				{
					// "Create New..."
					list.Add(resources.GetString(resourceName + "1", m_cultureInfo));
