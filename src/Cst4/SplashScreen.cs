...
namespace CST
{
	...
	public class SplashScreen : System.Windows.Forms.Form
	{
		...
		public SplashScreen()
		{
            ...
            this.ShowInTaskbar = SplashScreen.showInTaskbar;
		...
		private void InitializeComponent()
		{
			...
			this.lblStatus.Size = new System.Drawing.Size(442, 14);
		...
		static public void CloseForm()
		{
			if( ms_frmSplash != null && ms_frmSplash.IsDisposed == false )
			{
                ...
                ms_frmSplash.lblStatus.Visible = false;
        ...
        //FES
        static public void SetShowInTaskbar(bool show)
        {
            showInTaskbar = show;
        }
		...
		private void pnlStatus_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
		{
			if( m_bFirstLaunch == false && e.ClipRectangle.Width > 0 && m_iActualTicks > 1 &&
                m_rProgress.Height > 0 && m_rProgress.Width > 0)
			{
	...
	public class RegistryAccess
	{
		...
		private const string APPLICATION_NAME = "CST 4.0";
		...
		static public string GetStringRegistryValue_FES_HIDE(string key, string defaultValue)
		{
		...
		static public void SetStringRegistryValue_FES_HIDE(string key, string stringValue)
		{
