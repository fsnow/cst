...
/// <summary>
/// Shared base for the reactive dockable view models: combines Dock's IDockable with ReactiveUI's
/// ReactiveObject, so dockable ViewModels get IReactiveObject change notifications while remaining
/// compatible with the Dock layout system. ReactiveDocument and ReactiveTool extend this with the
/// IDocument / ITool marker interfaces; all the shared IDockable implementation lives here. (#74)
/// </summary>
[DataContract(IsReference = true)]
public class ReactiveDockableBase : ReactiveObject, IDockable
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ReactiveDockableBase"/> class.
    /// </summary>
    public ReactiveDockableBase()
    {
