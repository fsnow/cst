...
/// <summary>
/// Reactive tool base class that combines Dock.Model.Controls.ITool with ReactiveUI.ReactiveObject.
/// This enables ReactiveUI functionality (IReactiveObject) in tool ViewModels while maintaining
/// compatibility with the Dock layout system.
/// </summary>
[DataContract(IsReference = true)]
public class ReactiveTool : ReactiveObject, ITool, IDocument
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ReactiveTool"/> class.
    /// </summary>
    public ReactiveTool()
    {
